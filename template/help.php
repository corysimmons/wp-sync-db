...
<div class="help-tab content-tab">
	<div class="support">
		...
		<p><?php _e( 'Please report bugs or ask questions in the', 'wp-sync-db' ); ?> <a href="https://github.com/wp-sync-db/wp-sync-db/issues"><?php _e( 'GitHub Issue Tracker', 'wp-sync-db' ); ?></a>.</p>
	</div>
	<div class="debug">
